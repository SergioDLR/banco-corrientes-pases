      ...
      <NavLink style={{ color: 'inherit', textDecoration: 'inherit' }} to={'/'}>
        <Typography
          sx={{
            ...
            borderBottom: location.pathname === '/' ? ' 1px solid #ecac00' : ''
          }}
        >
          SALDO BASE
        </Typography>
      ...
      <NavLink style={{ color: 'inherit', textDecoration: 'inherit' }} to={'/consulta'}>
        <Typography
          sx={{
            ...
            ml: 2,
            borderRadius: '0px !important',
            borderBottom: location.pathname === '/consulta' ? ' 1px solid #ecac00' : ''
          }}
        >
          CONSULTA
        </Typography>
      ...
      <NavLink style={{ color: 'inherit', textDecoration: 'inherit' }} to={'/token'}>
        <Typography
          sx={{
            ...
            ml: 2,
            borderRadius: '0px !important',
            borderBottom: location.pathname === '/token' ? ' 1px solid #ecac00' : ''
          }}
        >
          TOKEN
        </Typography>
      ...
      <NavLink style={{ color: 'inherit', textDecoration: 'inherit' }} to={'/log'}>
        <Typography
          sx={{
            ...
            ml: 2,
            borderRadius: '0px !important',
            borderBottom: location.pathname === '/log' ? ' 1px solid #ecac00' : ''
          }}
        >
          AUDITORÍA
        </Typography>
